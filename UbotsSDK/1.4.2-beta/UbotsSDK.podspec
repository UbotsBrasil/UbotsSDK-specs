...
Pod::Spec.new do |s|
    s.name             = 'UbotsSDK'
    s.version          = '1.4.2-beta'
    s.summary          = 'SDK to connect with Ubots API'
    s.description      = 'Description'
    s.homepage         = 'https://github.com/UbotsBrasil/sdk-ios'
    s.license          = { :type => 'MIT', :file => 'LICENSE' }
    s.author           = { 'Ubots' => 'contato@ubots.com.br' }
    s.source           = { :git => 'https://github.com/UbotsBrasil/sdk-ios', :tag => s.version.to_s }
    s.swift_version    = '4.2'
    ...
    s.dependency 'XMPPFramework', '4.1.3'
